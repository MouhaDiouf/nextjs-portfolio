...
const data = {
    featuredProjects: [
        {
            title: "Appointcar",
            description: "A car appointment app. You can create your account and book for your next favorite car",
    ...
    otherProjects: [
        {
            ...
            website: "https://raw.githack.com/MouhaDiouf/New_york_times/master/index.html",
        },
        {
            title: "Newsweek",
            ...
            website: "https://newsweek-one.vercel.app/",
        },
        {
            title: "Robinhood",
        ...
        {
            title: "Asteroids",
            description: "This app communicates with the Nasa API to display asteroids based on their IDs or date.",
        ...
        {
            title: "Comfy House",
            description: "An e-commerce interface where the user can choose beds to add to its cart or remove them.",
            technologies: ["HTML", "CSS", "React.js"],
            slug: "nytimes",
            github: "https://github.com/MouhaDiouf/comfy-house",
            website: "https://raw.githack.com/MouhaDiouf/comfy-house/develop/index.html",
        },
        {
            title: "Cocktails",
            description: "The project is single page react app based on a catalog of cocktails.",
